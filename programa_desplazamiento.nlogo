...
to setup
  ...
  set-default-shape vecinos "person"
  cargar-mapa
  create-agentes
...
to create-agentes
 ...
 create-vecinos numero-citadinos [
  ...
  create-agricultores numero-agricultores [
    ...
    setxy (random (174 - 152) + 152) (random (17 - 1) + 1)]
    [
  ...
  create-guerrilleros (random (10 - 3) + 3)[
    ...
    ifelse (random-zone = 1 ) [
      ...
      setxy (random (178 - 175) + 175) (random (20 - 6) + 6)]
    [
...
to go
  ask turtles-on patches with[pcolor = gray][
    let din capital
    ifelse any? neighbors with[(pcolor = yellow  or pcolor = yellow - 1 )][
      move-to one-of neighbors with[(pcolor = yellow  or pcolor = yellow - 1 )]
      set target one-of other turtles-here
        ifelse any? other turtles-here and ([ color] of target = blue) and valor < din[
          set color green
          ask other turtles-here [
          die
          set din din - valor
          ]][
          ifelse not any? other turtles-here  and din < 30[
            set invasores invasores + 1
            set color brown
...
"" ""
PENS
"Encalle" 1.0 0 -7500403 true "" "plot count turtles-on patches with[pcolor = gray]"
"desplazados con casa" 1.0 0 -13840069 true "" "plot count turtles with [color = green and( pcolor = yellow or pcolor = yellow - 1 )]"
"habitantes originales con casa" 1.0 0 -13345367 true "" "plot count turtles with [color = blue and( pcolor = yellow or pcolor = yellow - 1 )]"
"invasores" 1.0 0 -955883 true "" "plot invasores"
...
1676
301
desplazados en zona 1
count turtles with [color = red and ycor < 16]
17
1
11
...
427
invasores en zona 1
count turtles with [color = brown and ycor < 16]
17
1
11
...
1869
305
nuevos habitantes zona 1
count turtles with [color = green and ycor < 16]
17
1
11
